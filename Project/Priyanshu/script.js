var questions = [{
    ...
    "img" : "https://ak.picdn.net/assets/cms/f3819ba883198b89684e2d99064d0972a7fc0d49-stofro_offset_02.png",
    "choices": ["Waterloo", "Baker Street", "Kings Cross", "Victoria"],
    "correctAnswer": "Waterloo"
}];
var currentQuestion = 0; //For JSON Array index track
var questionCount = 0; //Count the question no
var firstTime = false;
var userAnswer = []; //Store the value selected by user
var seconds;
var blank="";
...
function questionPage() {
    ...
    $(".prevButton").click(function() {
        ...
        if(currentQuestion<questions.length) {
         displayCurrentQuestion();
            var x = userAnswer[currentQuestion]; $('input[value='+userAnswer[currentQuestion]+']').prop('checked', true);
            $('input[value='+userAnswer[currentQuestion]+']').closest(".option").addClass("active");
...
//Display the current question called by questionPage
    ...
    var question = questions[currentQuestion].ques; 
    console.log(question);
    var questionClass = $(document).find(".questionSection > .question");
    var choiceList = $(document).find(".questionSection > .choice");
